    ...
    console.log('starRating:', starRating, 'parsedStarRating:', parsedStarRating, 'displayRating:', displayRating);
    ...
    return (
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden animate-fadeIn">
            ...
            <div className="flex-1">
                ...
                {/* <p className="text-gray-600 text-base sm:text-lg mt-1">{organizationName}</p> */}
