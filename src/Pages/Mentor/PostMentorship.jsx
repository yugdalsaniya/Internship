...
const PostMentorship = () => {
  ...
  const fetchRecentMentorships = async () => {
    try {
      ...
      if (data && Array.isArray(data)) {
        ...
        setRecentMentorships(formattedMentorships);
      } else {
        throw new Error('Invalid data format received');
      }
    } catch (err) {
      setError('Error fetching recent mentorship programs');
      console.error('PostMentorship API Error:', err);
      toast.error('Error fetching recent mentorship programs', {
        position: 'top-right',
        autoClose: 5000,
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans">
      ...
      >
        <div className="text-center px-4">
          ...
          <p className="text-sm md:text-base text-gray-700 max-w-md mx-auto mb-6">
            Guide the next generation of professionals with Inturnshp Philippines.
          </p>
          <button
            onClick={() => navigate('/post-mentorship-form')}
      ...
      <div className="px-4 md:px-12 py-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-[#050748] mb-6 text-center">
            Why Post Mentorship Programs with Us?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                title: 'Guide Top Talent',
                description: 'Mentor motivated students eager to learn and grow in their careers.',
              },
              {
                title: 'Build Your Influence',
                description: 'Showcase your expertise to the next generation of professionals.',
              },
              {
                title: 'Flexible Mentoring',
                description: 'Create programs tailored to your availability, from short-term to ongoing.',
              },
            ].map((benefit, index) => (
              <div
                key={index}
      ...
      {/* Recent Mentorships Section */}
      <div className="px-4 md:px-12 py-8 bg-gradient-to-b from-[#FFFCF2] to-[#FEEFF4]">
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-[#050748]">
              Your Recent Mentorship Programs
            </h2>
            <button
      ...
      <div className="px-4 md:px-12 py-8 bg-[#fafafa]">
        <div className="max-w-4xl mx-auto text-center bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl md:text-3xl font-bold text-[#050748] mb-4">
            Ready to Mentor More Students?
          </h2>
          <p className="text-sm text-gray-600 mb-6">
            Explore our platform features or contact our support team to learn more about how Inturnshp Philippines can help you mentor effectively.
          </p>
