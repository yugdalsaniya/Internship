...
const OtpVerification = () => {
  ...
  // Protect OTP page: Check for pendingUser on mount
  useEffect(() => {
    ...
    if (!pendingUser) {
      MySwal.fire({
        ...
        text: "Please sign up to access OTP verification.",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (otpResponse.success) {
        if (
          pendingUser.roleId === "1747825619417" ||
          pendingUser.roleId === "1747903042943"
        ) {
