                  ...
                  >
                    <div className="flex flex-col sm:flex-row justify-between mb-3 sm:mb-4 mt-3 sm:mt-4 items-center space-x-0 sm:space-x-4">
                      <div className="flex-1">
                        ...
                        <ul className="list-disc list-inside text-gray-600 mt-4 sm:mt-6 space-y-1">
                          <li>
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between mb-3 sm:mb-4 mt-3 sm:mt-4 items-center space-x-0 sm:space-x-4">
                <div className="flex-1">
                  ...
                  <ul className="list-disc list-inside text-gray-600 text-sm sm:text-base mt-4 sm:mt-6 space-y-1">
